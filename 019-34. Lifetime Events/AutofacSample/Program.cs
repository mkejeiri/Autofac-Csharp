...
namespace AutofacSample
{
    ...
    internal class Program {
        public static void Main(string[] args)
        {
            ...
            /*
             ERR: System.InvalidCastException: 'Unable to cast object of 
                  type 'AutofacSample.SMSLog' to type 'AutofacSample.ConsoleLog'.'
             
            builder.RegisterType<ConsoleLog>()
                .As<ILog>()
                .OnActivating(a => {
                    a.ReplaceInstance(new SMSLog("+345484545"));
                    });
            ...
            */
            ...
            builder.Register<ILog>(c => c.Resolve<ConsoleLog>())
                .OnActivating(a=>a.ReplaceInstance(new SMSLog("+345484545")));
            ...
            builder.RegisterType<Child>()
                .OnActivating(
                a => {
                    Console.WriteLine($"Child is activating!");
                    //a.Instance.Parent = a.Context.Resolve<Parent>();
                    a.ReplaceInstance(new BadChild() { Parent = a.Context.Resolve<Parent>() });
                })
                .OnActivated(c => Console.WriteLine($"Child is activated!"))
                .OnRelease(c => Console.WriteLine("Child is about to get removed!"));
